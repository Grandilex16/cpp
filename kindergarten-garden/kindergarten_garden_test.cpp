...
TEST_CASE("different garden with single student",
  ...
  std::array<kindergarten_garden::Plants, 4> expected{
      kindergarten_garden::Plants::violets, kindergarten_garden::Plants::clover,
      kindergarten_garden::Plants::radishes,
      kindergarten_garden::Plants::clover};
...
TEST_CASE("second student's garden", "[2d620f45-9617-4924-9d27-751c80d17db9]") {
  std::array<kindergarten_garden::Plants, 4> expected{
      kindergarten_garden::Plants::clover, kindergarten_garden::Plants::clover,
      kindergarten_garden::Plants::clover, kindergarten_garden::Plants::clover};
...
TEST_CASE("for Joseph", "[78578123-2755-4d4a-9c7d-e985b8dda1c6]") {
  std::array<kindergarten_garden::Plants, 4> expected{
      kindergarten_garden::Plants::violets, kindergarten_garden::Plants::clover,
      kindergarten_garden::Plants::violets, kindergarten_garden::Plants::grass};
  REQUIRE(kindergarten_garden::plants(
...
TEST_CASE("for Larry, last student's garden",
  ...
  std::array<kindergarten_garden::Plants, 4> expected{
      kindergarten_garden::Plants::grass, kindergarten_garden::Plants::violets,
      kindergarten_garden::Plants::clover,
      kindergarten_garden::Plants::violets};
  REQUIRE(kindergarten_garden::plants(
